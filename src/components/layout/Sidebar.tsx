...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Main Sidebar Drawer */}
      <aside
        className={`w-64 bg-[#1a2A2f] border-r border-[#1a2A2f] flex flex-col h-screen fixed left-0 top-0 z-50 shadow-2xl transition-transform duration-300 ease-in-out ${
          isMobileSidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
        }`}
      >
        {/* Brand Header (#1a2A2f) */}
        <div className="h-16 px-4 sm:px-5 flex items-center justify-between border-b border-[#131d22] bg-[#1a2A2f]">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-[#88BDF2] flex items-center justify-center shadow-md shrink-0">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#88BDF2] font-mono tracking-tight font-medium">Threat Intelligence</p>
            </div>
          </div>
          ...
          <button
            onClick={() => setIsMobileSidebarOpen(false)}
            className="p-1.5 rounded-lg bg-[#131d22] text-[#88BDF2] hover:bg-[#88BDF2] hover:text-[#1a2A2f] lg:hidden transition-colors"
